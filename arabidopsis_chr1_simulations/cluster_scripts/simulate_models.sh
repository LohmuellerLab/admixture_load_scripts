...
$((10000 + ${s} + 1000)) { 
    p1.outputVCFSample(1000, replace=F, filePath="/u/home/b/bkim331/project-klohmueldata/bernard_data/admixture_simulations_arabidopsis/${model}/h_s/hs_full_" + simnum + "_p1.vcf");
    p2.outputVCFSample(1000, replace=F, filePath="/u/home/b/bkim331/project-klohmueldata/bernard_data/admixture_simulations_arabidopsis/${model}/h_s/hs_full_" + simnum + "_p2.vcf");
}
...
cd /u/home/b/bkim331/project-klohmueldata/bernard_data/admixture_simulations_arabidopsis/${model}/h_s
burnseed=\${SGE_TASK_ID}
/u/home/b/bkim331/project-klohmueldata/bernard_data/SLiM/bin/slim -seed \${burnseed} slim_hs_full_split${s}.job
EOM
