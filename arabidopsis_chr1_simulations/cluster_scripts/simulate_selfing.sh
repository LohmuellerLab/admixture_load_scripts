...
$((10000 + ${s} + 1000)) { 
    p1.outputVCFSample(1000, replace=F, filePath="/u/home/b/bkim331/project-klohmueldata/bernard_data/admixture_simulations_arabidopsis/${model}/h_${h}/h${h}_self${selfingpercent}_" + simnum + "_p1.vcf");
    p2.outputVCFSample(1000, replace=F, filePath="/u/home/b/bkim331/project-klohmueldata/bernard_data/admixture_simulations_arabidopsis/${model}/h_${h}/h${h}_self${selfingpercent}_" + simnum + "_p2.vcf");
}
...
cd /u/home/b/bkim331/project-klohmueldata/bernard_data/admixture_simulations_arabidopsis/${model}/h_${h}
